...
fun <E> Table<E>.nullable(name: String, value: (E) -> String) = column(StringColumn(name = name, value = value))
fun <E> Table<E>.bool(name: String, value: (E) -> Boolean) = column(BooleanColumn(name = name, value = value))
fun <E> Table<E>.date(name: String, value: (E) -> LocalDate) = column(DateColumn(name = name, value = value))
fun <E> Table<E>.datetime(name: String, value: (E) -> LocalDateTime) = column(
    DateTimeColumn(name = name, value = value),
)

fun <E> Table<E>.nullableInteger(name: String, value: (E) -> Int?) = column(
    NullableIntegerColumn(name = name, value = value),
)

fun <E> Table<E>.nullableLong(name: String, value: (E) -> Long?) = column(
    NullableLongColumn(name = name, value = value),
)

fun <E> Table<E>.nullableFloat(name: String, value: (E) -> Float?) = column(
    NullableFloatColumn(name = name, value = value),
)

fun <E> Table<E>.nullableDouble(name: String, value: (E) -> Double?) = column(
    NullableDoubleColumn(name = name, value = value),
)

fun <E> Table<E>.nullableVarchar(name: String, value: (E) -> String?) = column(
    NullableStringColumn(name = name, value = value),
)

fun <E> Table<E>.nullableDate(name: String, value: (E) -> LocalDate?) = column(
    NullableDateColumn(name = name, value = value),
)

fun <E> Table<E>.nullableDatetime(name: String, value: (E) -> LocalDateTime?) = column(
