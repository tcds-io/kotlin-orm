...
class MapOrmResultSet(private val data: OrmResult<*>) : OrmResultSet {
    ...
    override fun get(column: Column<*, LocalDate>): LocalDate = data[column]!! as LocalDate
    ...
    override fun nullable(column: Column<*, LocalDate?>): LocalDate? = data[column]!! as LocalDate?
